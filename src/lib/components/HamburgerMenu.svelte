...
<div class="relative inline-block text-left">
	...
	{#if $menuOpen}
    <div transition:fly="{{ y: -10, duration: 150 }}"  class="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
        <div class="py-1" role="none">
            <a href="/" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="home">Home</a>
            <a href="/profile" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="profile">Profile</a>
        </div>
        <!-- <div class="py-1" role="none">
